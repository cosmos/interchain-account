...
var (
	pattern_Query_InterchainAccountFromAddress_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 1, 0, 4, 1, 5, 4}, []string{"inter-tx", "v1beta1", "interchain_account_from_address", "owner", "connection_id"}, "", runtime.AssumeColonVerbOpt(true)))
)
